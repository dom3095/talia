...
| ID | Titolo | Ruolo | Note |
|----|--------|-------|------|
| [TAL-49](TAL-49.md) | Censimento albi + rollout scraper comuni siciliani | 🕷️ SCR | branch `feat/E3-censimento-comuni-sicilia`, **PR #8 pronta per il merge**; 186 comuni (72,6% popolazione), 384 test |
