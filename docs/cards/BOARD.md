...
| ID | Titolo | Note |
|----|--------|------|
| — | Secondo sweep comuni residui (2026-08-06) | branch `feat/censimento-comuni-residui`; 17 hit su 106 comuni mai censiti (9 Halley EG, 3 jCityGov, 3 portalepa, 1 HSPromila), 16 verificati con atti reali e attivati (+2.475 atti, +116.978 abitanti, copertura 79,0%→81,0%), 1 pending (Valguarnera Caropepe, 0 atti); bugfix critico: fingerprint jCityGov dava 106/106 falsi positivi (403 wildcard del vendor su qualsiasi sottodominio) — corretto richiedendo marker reale nel body; 89 comuni ancora mai censiti, nessun pattern noto trovato; 545 test verdi |
